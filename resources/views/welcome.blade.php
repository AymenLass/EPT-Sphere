            ...
            <div class="d-md-flex justify-content-between">
                ...
                <div class="d-flex align-items-center py-2">
                    <div class="shadow rounded-8">
                        <img class="" src="{{ asset('images/logos/icon.png') }}" alt="EPTSphere" style="width: 80px">
                    </div>
                    <div class="ms-4">
                        <h1 class="text-primary mt-3 fw-bold mb-0">EPTSphere</h1>
                        <p>All services in one app</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card px-4 py-3 rounded-8 shadow-lg">
                        <div class="card-header">
                            <h2>Login</h2>
                            <p>Welcome to EPT School of Engineering</p>
                        </div>
                        <div class="card-body">
    ...
    <footer class="py-3 mt-5">
        <div class="container">
            <div class="d-flex justify-content-center">
                <img src="{{ asset('images/logos/univ_tc.png') }}" alt="" style="height: 45px">
                {{-- <img class="ms-4" src="{{ asset('images/logos/a2i-logo.png') }}" alt="" style="height: 45px"> --}}
                <img class="ms-4" src="{{ asset('images/logos/logo_ept.png') }}" alt=""
                    style="height: 45px">
            ...
            <div class="d-md-flex justify-content-center small mt-3">
                ...
                <div class="ms-1">
                    &middot;
                    <a href="https://ept.tn/">Visit EPT Offical Website</a>
                    &middot;
                    <a href="https://www.facebook.com/EcolePolytechniqueDeTunisie?locale=fr_FR">Facebook Offical Page</a>
                </div>
            </div>
        </div>
    </footer>
