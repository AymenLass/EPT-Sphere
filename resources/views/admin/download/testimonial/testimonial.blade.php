    ...
    <div class="d-flex justify-content-center py-4">
        <div class="testimonial shadow htmlContent">
            ...
            <p class="tml_desc mt-5">
                ...
                He passed the EPT examination of the Board of Multidisciplinary engineering Education, No. <b>{{ $data->roll }}</b> and Registration no. <b>{{ $data->reg }}</b>
                of the session <b>{{ $data->session }}</b>
                in <b>{{ $data->group }}</b> group and secured Average <b>{{ $data->gpa }}</b> in scale of Average 20.00.
            </p>
            <p class="tml_desc">
