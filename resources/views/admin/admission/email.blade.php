...
<body class="bg-light">
    ...
    {{-- <div class="d-flex justify-content-center my-4">
        <img src="{{ asset('images/logos/logo.png') }}" alt="EPTSphere" style="width:150px">
    </div> --}}
        ...
        <div class="card col-12 col-lg-5 col-md-7">
            <div class="card-body">
                ...
                <div class="text-center">
                    Visit EPTSphere to get more information- <br>
                    <a href="{{ route('home') }}" class="btn btn-primary text-white">Go to EPTSphere</a>
                </div>
                <br>
                Thanks,<br>
                {{ config('app.name') }}
