...
@section('content')
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header attachment-block p-3 d-flex justify-content-between">
                        ...
                        @if ($item->c_class == 'FirstY' || $item->c_class == 'SecondY')
                    ...
                    <div class="card-body pt-1">
                        <div class="tab-content">
                            <div class="active tab-pane" id="information">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    @if ($item->department == 'Science')
                                                        ...
                                                        <th>H. Math I</th>
                                                        <th>H. Math II</th>
                                                    @elseif ($item->department == 'Technologie')
                                                        <th>Logic I</th>
                                                        <th>Logic II</th>
                                                        <th>ElectronicsI</th>
                                                        <th>ElectronicsII</th>
                                            ...
                                            <tbody>
                                                @if ($xi_marks_mt != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xi_marks_mt->french1 }}</td>
                                                        <td>{{ $xi_marks_mt->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xi_marks_mt->Electrnics1 }}</td>
                                                            <td>{{ $xi_marks_mt->Electrnics2 }}</td>
                                                            <td>{{ $xi_marks_mt->Mechanics1 }}</td>
                                                            <td>{{ $xi_marks_mt->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xi_marks_mt->Robotics1 }}</td>
                                                            <td>{{ $xi_marks_mt->Robotics2 }}</td>
                                                        @else
                                                ...
                                                @if ($xi_marks_hy != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xi_marks_hy->french1 }}</td>
                                                        <td>{{ $xi_marks_hy->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xi_marks_hy->Electrnics1 }}</td>
                                                            <td>{{ $xi_marks_hy->Electrnics2 }}</td>
                                                            <td>{{ $xi_marks_hy->Mechanics1 }}</td>
                                                            <td>{{ $xi_marks_hy->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xi_marks_hy->Robotics1 }}</td>
                                                            <td>{{ $xi_marks_hy->Robotics2 }}</td>
                                                        @else
                                                ...
                                                @if ($xi_marks_fnl != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xi_marks_fnl->french1 }}</td>
                                                        <td>{{ $xi_marks_fnl->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xi_marks_fnl->Electrnics1 }}</td>
                                                            <td>{{ $xi_marks_fnl->Electrnics2 }}</td>
                                                            <td>{{ $xi_marks_fnl->Mechanics1 }}</td>
                                                            <td>{{ $xi_marks_fnl->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xi_marks_fnl->Robotics1 }}</td>
                                                            <td>{{ $xi_marks_fnl->Robotics2 }}</td>
                                                        @else
                                ...
                                <div class="card my-4">
                                    <div class="card-header attachment-block px-3 py-2  bg-gray-dark">
                                        <b>Exam records: class-SecondY</b>
                                    </div>
                                    <div class="card-body table-responsive p-0">
                                        <table class="table table-bordered table-striped examTable">
                                            <thead>
                                            ...
                                            <tbody>
                                                @if ($xii_marks_mt != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xii_marks_mt->french1 }}</td>
                                                        <td>{{ $xii_marks_mt->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xii_marks_mt->Electrnics1 }}</td>
                                                            <td>{{ $xii_marks_mt->Electrnics2 }}</td>
                                                            <td>{{ $xii_marks_mt->Mechanics1 }}</td>
                                                            <td>{{ $xii_marks_mt->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xii_marks_mt->Robotics1 }}</td>
                                                            <td>{{ $xii_marks_mt->Robotics2 }}</td>
                                                        @else
                                                ...
                                                @if ($xii_marks_hy != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xii_marks_hy->french1 }}</td>
                                                        <td>{{ $xii_marks_hy->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xii_marks_hy->Electrnics1 }}</td>
                                                            <td>{{ $xii_marks_hy->Electrnics2 }}</td>
                                                            <td>{{ $xii_marks_hy->Mechanics1 }}</td>
                                                            <td>{{ $xii_marks_hy->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xii_marks_hy->Robotics1 }}</td>
                                                            <td>{{ $xii_marks_hy->Robotics2 }}</td>
                                                        @else
                                                ...
                                                @if ($xii_marks_fnl != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $xii_marks_fnl->french1 }}</td>
                                                        <td>{{ $xii_marks_fnl->french2 }}</td>
                                                        ...
                                                        @if ($item->department == 'Science')
                                                            ...
                                                            <td>{{ $xii_marks_fnl->Electrnics1 }}</td>
                                                            <td>{{ $xii_marks_fnl->Electrnics2 }}</td>
                                                            <td>{{ $xii_marks_fnl->Mechanics1 }}</td>
                                                            <td>{{ $xii_marks_fnl->Mechanics2 }}</td>
                                                        ...
                                                        @elseif ($item->department == 'Technologie')
                                                            ...
                                                            <td>{{ $xii_marks_fnl->Robotics1 }}</td>
                                                            <td>{{ $xii_marks_fnl->Robotics2 }}</td>
                                                        @else
                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <form action="{{ route('students.update', $item->id) }}" method="post"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="department" class="form-control">
                                                ...
                                                <option value="Technologie"
                                                    @if ($item->department == 'Technologie') selected @endif>Technologie</option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="c_class" class="form-control">
                                                <option value="FirstY" @if ($item->c_class == 'FirstY') selected @endif>
                                                    FirstY
                                                </option>
                                                <option value="SecondY" @if ($item->c_class == 'SecondY') selected @endif>
                                                    SecondY
                                                </option>
                                                <option value="HSC_Examinee"
                                                    @if ($item->c_class == 'HSC_Examinee') selected @endif>ThirdY
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for=" birth_reg_nid">NID</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for=" ssc_res">SSC Average</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="ssc_dept" class="form-control">
                                                <option value="Science"
                                                    ...
                                                    Science</option>
                                                <option value="Technologie"
                                                    @if ($item->ssc_dept == 'Technologie') selected @endif>Technologie</option>
                                                <option value="Business"
    ...
    @include('admin.students.exam_modals.Technologie')
