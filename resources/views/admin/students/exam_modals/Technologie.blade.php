<div id="{{ 'Technologie' . $item->id . 'modal' }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-body">
                <fieldset class="show" id="{{ 'mt_hum' . $item->id . '1' }}">
                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="form-group col">
                                <label for="">Robotics I</label>
                                <input type="text" name="Robotics1" class="form-control"
                                    value="@if ($mt_mark != null) {{ $mt_mark->Robotics1 }} @endif">
                            </div>
                            <div class="form-group col">
                                <label for="">Robotics II</label>
                                <input type="text" name="Robotics2" class="form-control"
                                    value="@if ($mt_mark != null) {{ $mt_mark->Robotics2 }} @endif">
                            </div>
                        </div>
                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="form-group col">
                                <label for="">Robotics I</label>
                                <input type="text" name="Robotics1" class="form-control"
                                    value="@if ($hy_mark != null) {{ $hy_mark->Robotics1 }} @endif">
                            </div>
                            <div class="form-group col">
                                <label for="">Robotics II</label>
                                <input type="text" name="Robotics2" class="form-control"
                                    value="@if ($hy_mark != null) {{ $hy_mark->Robotics2 }} @endif">
                            </div>
                        </div>
                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="form-group col">
                                <label for="">Robotics I</label>
                                <input type="text" name="Robotics1" class="form-control"
                                    value="@if ($fnl_mark != null) {{ $fnl_mark->Robotics1 }} @endif">
                            </div>
                            <div class="form-group col">
                                <label for="">Robotics II</label>
                                <input type="text" name="Robotics2" class="form-control"
                                    value="@if ($fnl_mark != null) {{ $fnl_mark->Robotics2 }} @endif">
                            </div>
                        </div>
