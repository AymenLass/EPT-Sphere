...
@section('content')
    <div class="row justify-content-center">
        <div class="py-md-4 pt-4 col-12 col-lg-10">
            ...
            <div class="card mt-4">
                {{-- user  only see this 'cant see this when he opens other profile'--}}
                @if (Auth::user()->id == $user->id)
                <div class="card-body">
                    <h4 class="card-title">Update Profile Photo</h4>
                    <form method="POST" action="{{ route('change-profile-photo.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="profile_photo" name="user_image">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    @if ($user->department == 'Science')
                                                        ...
                                                        <th>H. Math I</th>
                                                        <th>H. Math II</th>
                                                    @elseif ($user->department == 'Technologie')
                                                        <th>Logic I</th>
                                                        <th>Logic II</th>
                                                        <th>ElectronicsI</th>
                                                        <th>ElectronicsII</th>
