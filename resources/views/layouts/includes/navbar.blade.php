    ...
    <div class="container-fluid justify-content-between row-lg">
        ...
        <div class="d-flex col-lg-4">
            ...
            <a class="navbar-brand mx-2 mb-1 d-flex align-items-center shadow rounded-8 p-0" href="{{ url('/') }}">
                <img class="m-0" src="{{ asset('images/logos/icon.png') }}" height="40" alt="EPTSphere" />
            </a>
        ...
        <ul class="navbar-nav flex-row justify-content-center justify-content-lg-end collapse navbar-collapse col-lg-4"
            ...
            <li class="nav-item dropdown me-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                    <li>
                        <a class="dropdown-item" href="https://intranet.ept.tn/site-note/">Your Attendance</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="https://ept.tn/">Official Website</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="https://www.facebook.com/EcolePolytechniqueDeTunisie?locale=fr_FR">Offcial FB Page</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown me-3">
