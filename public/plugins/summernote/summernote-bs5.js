...
var Signals= /*#__PURE__*/function () {
  ...
  History_createClass(History, [{
    ...
    /**
    * @method rewind
    * Rewinds the Signalsstack back to the first snapshot taken.
    ...
    */
    ...
    /**
    *  @method commit
    *  Resets Signalsstack, but keeps current editor's content.
    */
    ...
    /**
    * @method reset
    * Resets the Signalsstack completely; reverting to an empty editor.
    */
...
var Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    this.bullet = new Bullet();
    this.Signals= new History(context);
