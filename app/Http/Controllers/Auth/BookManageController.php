...
class BookManageController extends Controller
{
    ...
    public function electronics_book()
    {
        ...
        // C:\Users\user\EPT Sphere\resources\views\admin\students\electronics_book.blade.php

        return view('user.electronics_book',compact('book'));
    ...
    public function programming_book_student()
    {
        ...
        return view('users.books',compact('student','book'));
    ...
    public function electronics_book_student()
    {
        ...
        return view('admin.students.electronics_book',compact('student','book'));
