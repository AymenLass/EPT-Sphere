    ...
    public function setActiveStatus(Request $request)
{
    try {
        ...
        // Update the user's active status based on the request
        ...
        if ($user) {
            ...
            // Log success message
            Log::info("User's active status updated successfully for user ID: $userId");

            return Response::json(['status' => 'success'], 200);
        } else {
            // Log error message for user not found
            Log::error("User not found with ID: $userId");

            return Response::json(['status' => 'error', 'message' => 'User not found'], 404);
        }
    } catch (\Exception $e) {
        // Log error message for any other exception
        Log::error('Error updating active status: ' . $e->getMessage());
